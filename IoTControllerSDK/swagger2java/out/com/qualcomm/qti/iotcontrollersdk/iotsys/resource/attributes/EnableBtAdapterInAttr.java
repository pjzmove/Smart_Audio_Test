...
public class EnableBtAdapterInAttr implements IResourceAttributes {


    public boolean mAdapterState;

     public EnableBtAdapterInAttr() {
        mAdapterState = false;
     }
     ...
     public OcRepresentation pack() throws OcException {
         ...
         rep.setUri("/enable_bt_adapter_in_rep_uri");
   ...
   public Object getData() {
    EnableBtAdapterInAttr clonedObj = new EnableBtAdapterInAttr();
   ...
   public void setData(Object state) {
     if(state instanceof EnableBtAdapterInAttr) {
        EnableBtAdapterInAttr obj = (EnableBtAdapterInAttr) state;
