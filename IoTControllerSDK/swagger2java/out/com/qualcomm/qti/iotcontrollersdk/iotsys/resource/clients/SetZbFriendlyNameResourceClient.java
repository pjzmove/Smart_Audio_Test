...
public class SetZbFriendlyNameResourceClient extends IoTBaseResourceClient {

    private SetZbFriendlyNameResourceClient() {
    }

    public SetZbFriendlyNameResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.setZbFriendlyName");

        return super.construct(mHost, "/qti/iotsys/zigbee/setZbFriendlyName",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
