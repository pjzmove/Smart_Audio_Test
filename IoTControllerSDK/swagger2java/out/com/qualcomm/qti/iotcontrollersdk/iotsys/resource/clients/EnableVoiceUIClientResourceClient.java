...
public class EnableVoiceUIClientResourceClient extends IoTBaseResourceClient {

    private EnableVoiceUIClientResourceClient() {
    }

    public EnableVoiceUIClientResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.enableVoiceUIClient");

        return super.construct(mHost, "/qti/iotsys/voiceUI/enableVoiceUIClient",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
