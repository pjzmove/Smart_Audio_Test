...
public class DisconnectBtDeviceResourceClient extends IoTBaseResourceClient {

    private DisconnectBtDeviceResourceClient() {
    }

    public DisconnectBtDeviceResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.disconnectBtDevice");

        return super.construct(mHost, "/qti/iotsys/bluetooth/disconnectBtDevice",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
