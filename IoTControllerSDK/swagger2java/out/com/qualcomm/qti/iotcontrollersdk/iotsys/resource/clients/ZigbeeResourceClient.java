...
public class ZigbeeResourceClient extends IoTBaseResourceClient {

    private ZigbeeResourceClient() {
    }

    public ZigbeeResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.zigbee");

        return super.construct(mHost, "/qti/iotsys/zigbee",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
