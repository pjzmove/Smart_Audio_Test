...
public class JoinZbNetworkResourceClient extends IoTBaseResourceClient {

    private JoinZbNetworkResourceClient() {
    }

    public JoinZbNetworkResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.joinZbNetwork");

        return super.construct(mHost, "/qti/iotsys/zigbee/joinZbNetwork",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
