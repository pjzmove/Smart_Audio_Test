...
public class EnableBtAdapterResourceClient extends IoTBaseResourceClient {

    private EnableBtAdapterResourceClient() {
    }

    public EnableBtAdapterResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.enableBtAdapter");

        return super.construct(mHost, "/qti/iotsys/bluetooth/enableBtAdapter",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
