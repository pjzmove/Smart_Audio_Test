...
public class StartZbJoiningResourceClient extends IoTBaseResourceClient {

    private StartZbJoiningResourceClient() {
    }

    public StartZbJoiningResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.startZbJoining");

        return super.construct(mHost, "/qti/iotsys/zigbee/startZbJoining",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
