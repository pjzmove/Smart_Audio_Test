...
public class ConnectBtDeviceResourceClient extends IoTBaseResourceClient {

    private ConnectBtDeviceResourceClient() {
    }

    public ConnectBtDeviceResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.connectBtDevice");

        return super.construct(mHost, "/qti/iotsys/bluetooth/connectBtDevice",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
