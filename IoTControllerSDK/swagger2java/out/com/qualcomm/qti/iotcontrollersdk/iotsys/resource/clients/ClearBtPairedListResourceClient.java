...
public class ClearBtPairedListResourceClient extends IoTBaseResourceClient {

    private ClearBtPairedListResourceClient() {
    }

    public ClearBtPairedListResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.clearBtPairedList");

        return super.construct(mHost, "/qti/iotsys/bluetooth/clearBtPairedList",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
