...
public class StartAVSOnboardingResourceClient extends IoTBaseResourceClient {

    private StartAVSOnboardingResourceClient() {
    }

    public StartAVSOnboardingResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.startAVSOnboarding");

        return super.construct(mHost, "/qti/iotsys/voiceUI/startAVSOnboarding",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
