...
public class GetBtPairedDevicesResourceClient extends IoTBaseResourceClient {

    private GetBtPairedDevicesResourceClient() {
    }

    public GetBtPairedDevicesResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.getBtPairedDevices");

        return super.construct(mHost, "/qti/iotsys/bluetooth/getBtPairedDevices",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
