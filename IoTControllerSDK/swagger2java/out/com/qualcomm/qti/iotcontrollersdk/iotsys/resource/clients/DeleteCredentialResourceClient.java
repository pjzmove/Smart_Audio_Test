...
public class DeleteCredentialResourceClient extends IoTBaseResourceClient {

    private DeleteCredentialResourceClient() {
    }

    public DeleteCredentialResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.deleteCredential");

        return super.construct(mHost, "/qti/iotsys/voiceUI/deleteCredential",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
