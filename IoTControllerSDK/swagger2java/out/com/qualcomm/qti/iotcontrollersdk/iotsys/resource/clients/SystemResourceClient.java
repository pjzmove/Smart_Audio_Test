...
public class SystemResourceClient extends IoTBaseResourceClient {

    private SystemResourceClient() {
    }

    public SystemResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.system");

        return super.construct(mHost, "/qti/iotsys/system",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
