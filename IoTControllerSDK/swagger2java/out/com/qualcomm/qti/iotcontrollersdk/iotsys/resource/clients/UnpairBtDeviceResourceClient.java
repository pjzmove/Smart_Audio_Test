...
public class UnpairBtDeviceResourceClient extends IoTBaseResourceClient {

    private UnpairBtDeviceResourceClient() {
    }

    public UnpairBtDeviceResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.unpairBtDevice");

        return super.construct(mHost, "/qti/iotsys/bluetooth/unpairBtDevice",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
