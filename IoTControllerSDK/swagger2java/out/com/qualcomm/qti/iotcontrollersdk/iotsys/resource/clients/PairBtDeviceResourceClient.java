...
public class PairBtDeviceResourceClient extends IoTBaseResourceClient {

    private PairBtDeviceResourceClient() {
    }

    public PairBtDeviceResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.pairBtDevice");

        return super.construct(mHost, "/qti/iotsys/bluetooth/pairBtDevice",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
