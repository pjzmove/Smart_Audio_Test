...
public class EnableZbAdapterResourceClient extends IoTBaseResourceClient {

    private EnableZbAdapterResourceClient() {
    }

    public EnableZbAdapterResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.iotsys.r.enableZbAdapter");

        return super.construct(mHost, "/qti/iotsys/zigbee/enableZbAdapter",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
