...
public class PauseResourceClient extends IoTBaseResourceClient {

    private PauseResourceClient() {
    }

    public PauseResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.pause");

        return super.construct(mHost, "/qti/allplay/mediaPlayer/pause",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
