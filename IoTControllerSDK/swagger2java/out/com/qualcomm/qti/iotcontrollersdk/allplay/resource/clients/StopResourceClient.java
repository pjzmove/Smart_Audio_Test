...
public class StopResourceClient extends IoTBaseResourceClient {

    private StopResourceClient() {
    }

    public StopResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.stop");

        return super.construct(mHost, "/qti/allplay/mediaPlayer/stop",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
