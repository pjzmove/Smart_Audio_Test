...
public class GroupAddToGroupResourceClient extends IoTBaseResourceClient {

    private GroupAddToGroupResourceClient() {
    }

    public GroupAddToGroupResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.groupAddToGroup");

        return super.construct(mHost, "/qti/allplay/group/groupAddToGroup",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
