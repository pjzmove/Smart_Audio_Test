...
public class CapabilitiesResourceClient extends IoTBaseResourceClient {

    private CapabilitiesResourceClient() {
    }

    public CapabilitiesResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.capabilities");

        return super.construct(mHost, "/qti/allplay/capabilities",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
