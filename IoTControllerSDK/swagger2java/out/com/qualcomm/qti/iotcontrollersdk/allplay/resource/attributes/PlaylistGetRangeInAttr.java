...
public class PlaylistGetRangeInAttr implements IResourceAttributes {
    ...
    public int mStart;
     ...
     public OcRepresentation pack() throws OcException {
         ...
         rep.setUri("/playlist_get_range_in_rep_uri");
   ...
   public Object getData() {
    PlaylistGetRangeInAttr clonedObj = new PlaylistGetRangeInAttr();
   ...
   public void setData(Object state) {
     if(state instanceof PlaylistGetRangeInAttr) {
        PlaylistGetRangeInAttr obj = (PlaylistGetRangeInAttr) state;
