...
public class RegisterForSurroundSignalsResourceClient extends IoTBaseResourceClient {

    private RegisterForSurroundSignalsResourceClient() {
    }

    public RegisterForSurroundSignalsResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.registerForSurroundSignals");

        return super.construct(mHost, "/qti/allplay/multichannelGroupMain/registerForSurroundSignals",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
