...
public class EqualizerResourceClient extends IoTBaseResourceClient {

    private EqualizerResourceClient() {
    }

    public EqualizerResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.equalizer");

        return super.construct(mHost, "/qti/allplay/equalizer",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
