...
public class AdjustVolumeResourceClient extends IoTBaseResourceClient {

    private AdjustVolumeResourceClient() {
    }

    public AdjustVolumeResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.adjustVolume");

        return super.construct(mHost, "/qti/allplay/volumeControl/adjustVolume",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
