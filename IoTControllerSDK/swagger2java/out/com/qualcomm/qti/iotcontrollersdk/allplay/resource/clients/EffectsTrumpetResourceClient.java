...
public class EffectsTrumpetResourceClient extends IoTBaseResourceClient {

    private EffectsTrumpetResourceClient() {
    }

    public EffectsTrumpetResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.effectsTrumpet");

        return super.construct(mHost, "/qti/allplay/effectsTrumpet",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
