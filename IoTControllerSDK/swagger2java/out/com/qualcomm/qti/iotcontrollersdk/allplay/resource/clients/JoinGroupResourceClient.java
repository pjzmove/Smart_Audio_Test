...
public class JoinGroupResourceClient extends IoTBaseResourceClient {

    private JoinGroupResourceClient() {
    }

    public JoinGroupResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.joinGroup");

        return super.construct(mHost, "/qti/allplay/multichannelGroupSatellite/joinGroup",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
