...
public class OutputSelectorResourceClient extends IoTBaseResourceClient {

    private OutputSelectorResourceClient() {
    }

    public OutputSelectorResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.outputSelector");

        return super.construct(mHost, "/qti/allplay/outputSelector",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
