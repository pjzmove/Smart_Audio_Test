...
public class GetPresetDetailsResourceClient extends IoTBaseResourceClient {

    private GetPresetDetailsResourceClient() {
    }

    public GetPresetDetailsResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.getPresetDetails");

        return super.construct(mHost, "/qti/allplay/equalizer/getPresetDetails",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
