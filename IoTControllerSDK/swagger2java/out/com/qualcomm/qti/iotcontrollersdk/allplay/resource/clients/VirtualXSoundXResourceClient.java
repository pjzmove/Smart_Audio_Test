...
public class VirtualXSoundXResourceClient extends IoTBaseResourceClient {

    private VirtualXSoundXResourceClient() {
    }

    public VirtualXSoundXResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.virtualXSoundX");

        return super.construct(mHost, "/qti/allplay/virtualXSoundX",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
