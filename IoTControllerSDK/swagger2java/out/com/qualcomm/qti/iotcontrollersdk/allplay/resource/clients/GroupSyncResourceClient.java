...
public class GroupSyncResourceClient extends IoTBaseResourceClient {

    private GroupSyncResourceClient() {
    }

    public GroupSyncResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.groupSync");

        return super.construct(mHost, "/qti/allplay/group/groupSync",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
