...
public class PreviousResourceClient extends IoTBaseResourceClient {

    private PreviousResourceClient() {
    }

    public PreviousResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.previous");

        return super.construct(mHost, "/qti/allplay/mediaPlayer/previous",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
