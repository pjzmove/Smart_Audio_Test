...
public class GroupDeleteResourceClient extends IoTBaseResourceClient {

    private GroupDeleteResourceClient() {
    }

    public GroupDeleteResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.groupDelete");

        return super.construct(mHost, "/qti/allplay/group/groupDelete",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
