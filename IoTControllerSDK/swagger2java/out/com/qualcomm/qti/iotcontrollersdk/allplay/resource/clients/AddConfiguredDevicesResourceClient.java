...
public class AddConfiguredDevicesResourceClient extends IoTBaseResourceClient {

    private AddConfiguredDevicesResourceClient() {
    }

    public AddConfiguredDevicesResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.addConfiguredDevices");

        return super.construct(mHost, "/qti/allplay/multichannelGroupMain/addConfiguredDevices",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
