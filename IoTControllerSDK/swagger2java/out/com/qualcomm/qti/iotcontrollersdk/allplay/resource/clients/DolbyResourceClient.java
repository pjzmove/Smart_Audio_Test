...
public class DolbyResourceClient extends IoTBaseResourceClient {

    private DolbyResourceClient() {
    }

    public DolbyResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.dolby");

        return super.construct(mHost, "/qti/allplay/dolby",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
