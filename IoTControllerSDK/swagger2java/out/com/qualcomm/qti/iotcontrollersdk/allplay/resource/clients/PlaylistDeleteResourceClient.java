...
public class PlaylistDeleteResourceClient extends IoTBaseResourceClient {

    private PlaylistDeleteResourceClient() {
    }

    public PlaylistDeleteResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.playlistDelete");

        return super.construct(mHost, "/qti/allplay/playlist/playlistDelete",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
