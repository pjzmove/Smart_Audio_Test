...
public class PlaylistInsertResourceClient extends IoTBaseResourceClient {

    private PlaylistInsertResourceClient() {
    }

    public PlaylistInsertResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.playlistInsert");

        return super.construct(mHost, "/qti/allplay/playlist/playlistInsert",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
