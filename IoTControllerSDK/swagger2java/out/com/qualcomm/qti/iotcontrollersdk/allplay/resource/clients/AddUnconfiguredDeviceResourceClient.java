...
public class AddUnconfiguredDeviceResourceClient extends IoTBaseResourceClient {

    private AddUnconfiguredDeviceResourceClient() {
    }

    public AddUnconfiguredDeviceResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.addUnconfiguredDevice");

        return super.construct(mHost, "/qti/allplay/multichannelGroupMain/addUnconfiguredDevice",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
