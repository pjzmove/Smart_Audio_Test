...
public class PresetReverbResourceClient extends IoTBaseResourceClient {

    private PresetReverbResourceClient() {
    }

    public PresetReverbResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.presetReverb");

        return super.construct(mHost, "/qti/allplay/presetReverb",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
