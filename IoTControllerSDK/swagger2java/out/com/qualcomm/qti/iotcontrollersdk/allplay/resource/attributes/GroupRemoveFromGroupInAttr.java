...
public class GroupRemoveFromGroupInAttr implements IResourceAttributes {


    public String mDeviceId;
    public String mGroupId;

     public GroupRemoveFromGroupInAttr() {
        mDeviceId = "";
        mGroupId = "";
     }
     ...
     public OcRepresentation pack() throws OcException {
         ...
         rep.setUri("/group_remove_from_group_in_rep_uri");
   ...
   public Object getData() {
    GroupRemoveFromGroupInAttr clonedObj = new GroupRemoveFromGroupInAttr();
   ...
   public void setData(Object state) {
     if(state instanceof GroupRemoveFromGroupInAttr) {
        GroupRemoveFromGroupInAttr obj = (GroupRemoveFromGroupInAttr) state;
