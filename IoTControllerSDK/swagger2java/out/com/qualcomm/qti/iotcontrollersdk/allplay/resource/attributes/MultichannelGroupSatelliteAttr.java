...
public class MultichannelGroupSatelliteAttr implements IResourceAttributes {


    public int mVersion;

     public MultichannelGroupSatelliteAttr() {
        mVersion = 0;
     }
     ...
     public OcRepresentation pack() throws OcException {
         ...
         rep.setUri("/multichannel_group_satellite_rep_uri");
   ...
   public Object getData() {
    MultichannelGroupSatelliteAttr clonedObj = new MultichannelGroupSatelliteAttr();
   ...
   public void setData(Object state) {
     if(state instanceof MultichannelGroupSatelliteAttr) {
        MultichannelGroupSatelliteAttr obj = (MultichannelGroupSatelliteAttr) state;
