...
public class InputSelectorResourceClient extends IoTBaseResourceClient {

    private InputSelectorResourceClient() {
    }

    public InputSelectorResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.inputSelector");

        return super.construct(mHost, "/qti/allplay/inputSelector",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
