...
public class GroupVolumeControlResourceClient extends IoTBaseResourceClient {

    private GroupVolumeControlResourceClient() {
    }

    public GroupVolumeControlResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.groupVolumeControl");

        return super.construct(mHost, "/qti/allplay/groupVolumeControl",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
