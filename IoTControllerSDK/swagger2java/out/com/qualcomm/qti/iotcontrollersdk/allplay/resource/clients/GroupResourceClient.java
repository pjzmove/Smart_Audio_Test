...
public class GroupResourceClient extends IoTBaseResourceClient {

    private GroupResourceClient() {
    }

    public GroupResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.group");

        return super.construct(mHost, "/qti/allplay/group",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
