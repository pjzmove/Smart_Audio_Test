...
public class GroupVolumeSyncResourceClient extends IoTBaseResourceClient {

    private GroupVolumeSyncResourceClient() {
    }

    public GroupVolumeSyncResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.groupVolumeSync");

        return super.construct(mHost, "/qti/allplay/groupVolumeControl/groupVolumeSync",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
