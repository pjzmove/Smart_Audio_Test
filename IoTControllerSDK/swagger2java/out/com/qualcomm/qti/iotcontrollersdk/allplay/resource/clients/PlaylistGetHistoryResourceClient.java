...
public class PlaylistGetHistoryResourceClient extends IoTBaseResourceClient {

    private PlaylistGetHistoryResourceClient() {
    }

    public PlaylistGetHistoryResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.playlistGetHistory");

        return super.construct(mHost, "/qti/allplay/playlist/playlistGetHistory",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
