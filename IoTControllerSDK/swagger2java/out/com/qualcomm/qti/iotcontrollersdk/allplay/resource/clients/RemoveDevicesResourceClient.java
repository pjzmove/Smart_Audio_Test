...
public class RemoveDevicesResourceClient extends IoTBaseResourceClient {

    private RemoveDevicesResourceClient() {
    }

    public RemoveDevicesResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.removeDevices");

        return super.construct(mHost, "/qti/allplay/multichannelGroupMain/removeDevices",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
