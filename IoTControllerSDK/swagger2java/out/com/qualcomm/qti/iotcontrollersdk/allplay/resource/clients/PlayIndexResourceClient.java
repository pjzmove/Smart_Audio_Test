...
public class PlayIndexResourceClient extends IoTBaseResourceClient {

    private PlayIndexResourceClient() {
    }

    public PlayIndexResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.playIndex");

        return super.construct(mHost, "/qti/allplay/mediaPlayer/playIndex",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
