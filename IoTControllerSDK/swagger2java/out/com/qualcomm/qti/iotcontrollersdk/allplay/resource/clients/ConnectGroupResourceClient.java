...
public class ConnectGroupResourceClient extends IoTBaseResourceClient {

    private ConnectGroupResourceClient() {
    }

    public ConnectGroupResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.connectGroup");

        return super.construct(mHost, "/qti/allplay/multichannelGroupMain/connectGroup",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
