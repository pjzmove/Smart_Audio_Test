...
public class PlayItemResourceClient extends IoTBaseResourceClient {

    private PlayItemResourceClient() {
    }

    public PlayItemResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.playItem");

        return super.construct(mHost, "/qti/allplay/mediaPlayer/playItem",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
