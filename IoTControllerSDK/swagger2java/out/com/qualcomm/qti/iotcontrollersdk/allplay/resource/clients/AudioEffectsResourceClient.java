...
public class AudioEffectsResourceClient extends IoTBaseResourceClient {

    private AudioEffectsResourceClient() {
    }

    public AudioEffectsResourceClient(String host) throws OcException {
        super(host);
        construct();
    }
    ...
    public OcResource construct() throws OcException {
        ...
        typeList.add("qti.allplay.r.audioEffects");

        return super.construct(mHost, "/qti/allplay/audioEffects",
                        typeList,
                        interfacesList,
                        isObserveSupported());
    }
